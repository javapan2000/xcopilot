...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '63bd3cb2-4272-4776-83f4-54500b7aebfd' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b2acbf58-0c0d-43d5-ae2e-1eefbd4b985e');
      cy.get(`[data-cy="name"]`).should('have.value', 'b2acbf58-0c0d-43d5-ae2e-1eefbd4b985e');
